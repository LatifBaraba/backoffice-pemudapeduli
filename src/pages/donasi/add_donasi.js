                      ...
                      <div className="form-row">
                        ...
                        <div className="col-md-12 mb-3">
                          ...
                          <input
                            ...
                            type="text"
                            value={target}
                            placeholder="Target Total Donasi"
                            ref={register({ required: true })}
                        ...
                        <div className="col-md-12 mb-3">
                          ...
                          <input
                            ...
                            name="ayobantu"
                            type="url"
                            placeholder="https://ayobantu.com/xxx"
                            onChange={(e) => setAyoBantu(e.target.value)}
                          />
                        ...
                        <div className="col-md-12 mb-3">
                          ...
                          <input
                            ...
                            name="kitabisa"
                            type="url"
                            placeholder="https://kitabisa.com/xxx"
                            onChange={(e) => setKitaBisa(e.target.value)}
                          />
                          <span>
                            {errors.kitabisa && "Facebook Link is required"}
                          </span>
                          <div className="valid-feedback">{"Looks good!"}</div>
                        </div>
                        <div className="col-md-12 mb-3">
                          ...
                          <Form.Group controlId="formPenggalangDana">
                            ...
                            >
                              ...
                              {penggalangData.map((penggalang, index) => (
                                <option
                                  key={index}
                                  value={penggalang.IDPPCPPenggalangDana}
                                >
                                  {penggalang.Name}
                                </option>
                              ))}
