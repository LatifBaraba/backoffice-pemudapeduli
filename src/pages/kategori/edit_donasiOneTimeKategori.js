...
import { fetchEditDonasiKategori, fetchEditDonasiOneTimeKategori } from "../../redux/donasiKategori/action";
...
const EditDonasiKategori = (props) => {
    ...
    const onSubmit = data => {
        if (data !== '') {
            dispatch(fetchEditDonasiOneTimeKategori(token, id, kategori))
        } else {
            errors.showMessages();
        }
    }
