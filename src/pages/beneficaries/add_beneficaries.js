...
import { fetchAddBeneficaries } from "../../redux/beneficaries/action";
    ...
    const onSubmit = data => {
        if (data !== '') {
            uploadImage(img).then(message => {
                ...
                dispatch(fetchAddBeneficaries(token, newThumb))
            })
            .catch(error => {
...
export default AddBeneficaries