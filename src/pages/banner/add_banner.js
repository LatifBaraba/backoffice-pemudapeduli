                                        ...
                                        <div className="col-md-6 col-sm-12">
                                            <div className="form-row">
                                                ...
                                                <div className="col-md-12 mb-3">
                                                    ...
                                                    <input className="form-control" name="title_content" type="text" placeholder="Title-content" onChange={(e) => setTitContent(e.target.value)} />
                                                ...
                                                <div className="col-md-12 mb-3">
                                                    ...
                                                    <div className="valid-feedback">{"Looks good!"}</div> */}
                                                    <input className="form-control" name="tag" type="text" placeholder="Tag Banner" ref={register({ required: true })} onChange={(e) => setTag(e.target.value)} />
