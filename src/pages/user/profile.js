                                        ...
                                        <div className="col-md-6 col-sm-12">
                                            <div className="form-row">
                                                <div className="col-md-12 mb-3">
                                                    ...
                                                    <input className="form-control" name="username" type="text" value={profile.username} ref={register({ required: true })} onChange={(e) => setUsername(e.target.value)}/>
                                                    <span>{errors.username && 'Name is required'}</span>
                                                    <div className="valid-feedback">{"Looks good!"}</div>
                                                </div>
                                                <div className="col-md-12 mb-3">
                                                    <label htmlFor="validationCustom01">{"Fullname"}</label>
                                                    <input className="form-control" name="fullname" type="text" value={profile.nama_lengkap} ref={register({ required: true })} onChange={(e) => setFullname(e.target.value)} />
                                                ...
                                                <div className="col-md-12 mb-3">
                                                    ...
                                                    <input className="form-control" name="email" type="email" value={profile.email} placeholder="Email" ref={register({ required: true })} onChange={(e) => setEmail(e.target.value)} />
                                                    <span>{errors.email && 'Email is required'}</span>
                                                    <div className="valid-feedback">{"Looks good!"}</div>
                                                </div>
                                                <div className="col-md-12 mb-3">
                                                    <label htmlFor="validationCustom01">{"Address"}</label>
                                                    <input className="form-control" name="alamat" type="text" value={profile.alamat} placeholder="Address" ref={register({ required: true })} onChange={(e) => setAddress(e.target.value)} />
