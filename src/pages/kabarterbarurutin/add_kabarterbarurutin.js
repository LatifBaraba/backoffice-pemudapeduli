...
import { fetchAddKabarTerbaruRutin } from "../../redux/kabarterbaru/action";
...
const AddKabarTerbaruRutin = () => {
  ...
  const [id_pp_cp_program_donasi_rutin, setIdProgramDonasiRutin] = useState("");
                        ...
                        <div className="col-md-12 mb-3">
                          ...
                          <Form.Group controlId="formPenggalangDana">
                            <Form.Control
                              ...
                              type="select"
                              onChange={(e) =>
                                setIdProgramDonasiRutin(e.target.value)
                              }
                              // {...register("tipebayar", {
                              //   required: true,
                              // })}
                            >
                              ...
                              {donasiRutinData.map((donasi, index) => (
...
export default AddKabarTerbaruRutin;
